...
<p><span style="font-size:18px">Your task is to complete the function <strong>minCost()&nbsp;</strong>which takes a 2D integer matrix <strong>costs&nbsp;</strong>as the only argument and returns an integer, representing the minimum cost to paint&nbsp;all the walls.</span></p>

<p><span style="font-size:18px"><strong>Expected Time Complexity: O(N*K)<br>
...
<p><span style="font-size:18px">If you are not able to paint&nbsp;all the walls, then you should <strong>return -1</strong>.</span></p>
</div>