<h2><a href="https://leetcode.com/problems/check-if-a-string-is-an-acronym-of-words">Check if a String Is an Acronym of Words</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>Given an array of strings <code>words</code> and a string <code>s</code>, determine if <code>s</code> is an <strong>acronym</strong> of words.</p>
